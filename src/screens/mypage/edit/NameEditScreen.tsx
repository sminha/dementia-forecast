...
const NameEditScreen = () => {
  ...
  const isFormValid = () => {
    return name && name !== userInfo.name;
  };
  ...
  const handleUpdate = async () => {
    ...
    // dispatch(updateUser({ token: accessToken, userInfo: { ...userInfo }, updatedFields: { name } }));
    dispatch(updateUser({ token: accessToken, userInfo: { ...userInfo, name } }));
        ...
        <View style={styles.section}>
          <View style={styles.title}>
            <TouchableOpacity style={styles.titleRow}>
              <CustomText style={styles.titleText}>이름 수정하기</CustomText>
            </TouchableOpacity>
          </View>
        </View>

        <View style={styles.inputGroup}>
          <CustomText style={[styles.labelText, focusedField === 'name' && styles.labelTextFocused]}>이름</CustomText>
          <View style={styles.inputFieldWrapper}>
            <TextInput
              ...
              onChangeText={(text) => {
                setName(text);
                // dispatch(setUserInfo({ field: 'name', value: text }));
              }}
              value={name}
            />
            {name !== '' &&
